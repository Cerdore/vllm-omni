...
Each window stays inside the native 4-15 s contract; the previous window's
tail (video + audio) conditions the next window, and the regenerated overlap is
dropped on concatenation. This runs in request mode (no --step-execution).
